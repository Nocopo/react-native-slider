...
return _this.props.handleOnPress?true:_this._thumbHitTest(e);
},_this.

_handleMoveShouldSetPanResponder=function(){

return _this.props.handleOnPress;
},_this.
...
_this._setCurrentValue(_this._getValue(gestureState,e.nativeEvent));
...
_getValue=function(gestureState,nativeEvent){
var thumbTouchRect=_this._getThumbTouchRect();
var length=_this.state.containerSize.width-_this.state.thumbSize.width;
var pressLeft=_this.props.handleOnPress&&nativeEvent&&gestureState.dx===0?nativeEvent.locationX-_this.props.thumbTouchSize.width/2:0;
var thumbLeft=pressLeft||_this._previousLeft+gestureState.dx;
